...
function hasAnimal(animals, animalName) {
  const mapAnimals = animals.map((animal) => animal.toLowerCase());
  return mapAnimals.includes(animalName.toLowerCase());

  // const smallAnimals = animals.toLowerCase();
  // const smallAnimalName = animalName.toLowerCase();
  // return smallAnimals.includes(smallAnimalName);
}
